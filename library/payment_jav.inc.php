...
function ValidateDateGreaterThanMargin(DateValue,DateFormat)
 {//Validate whether the date is greater that a reasonable future margin.The 3 formats of date is taken care of.
  if(DateFormat=='%Y-%m-%d')
   {
    DateValueArray=DateValue.split('-');
	DateValue=DateValueArray[1]+'/'+DateValueArray[2]+'/'+DateValueArray[0];
...
function FormValidations()
 {//Screen validations are done here.
  ...
  else if(!ValidateDateGreaterThanMargin(document.getElementById('check_date').value,'<?php echo DateFormatRead();?>'))
   {
    alert("<?php echo htmlspecialchars( xl('Date Cannot be greater than 3 days in the future'), ENT_QUOTES) ?>");
	document.getElementById('check_date').focus();
	return false;
   }
  ...
  else if(!ValidateDateGreaterThanMargin(document.getElementById('post_to_date').value,'<?php echo DateFormatRead();?>'))
   {
    alert("<?php echo htmlspecialchars( xl('Post To Date Cannot be greater than 3 days in the future'), ENT_QUOTES) ?>");
	document.getElementById('post_to_date').focus();
	return false;
   }
  ...
  else if(!ValidateDateGreaterThanMargin(document.getElementById('deposit_date').value,'<?php echo DateFormatRead();?>'))
   {
    alert("<?php echo htmlspecialchars( xl('Deposit Date Cannot be greater than 3 days in the future'), ENT_QUOTES) ?>");
