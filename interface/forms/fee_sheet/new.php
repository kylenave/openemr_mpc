...
if ($billresult) {
  foreach ($billresult as $iter) {
    ...
    if (empty($justify) && $code_type=='CPT4') {
       $msg = 'Error: Code ' . $code . ' needs a diagnosis.';
...
<span>Anesthesia Calculator:</span><br>
<span>Code:</span>
...
<option value='27096'>27096</option>
<option value='62264'>62264</option>
<option value='62273'>62273</option>
<option value='62290'>62290</option>
<option value='62320'>62320</option>
<option value='62321'>62321</option>
<option value='62322'>62322</option>
<option value='62323'>62323</option>
<option value='62362'>62362</option>
<option value='63650'>63650</option>
<option value='63661'>63661</option>
<option value='63688'>63688</option>
<option value='64400'>64400</option>
<option value='64405'>64405</option>
<option value='64418'>64418</option>
<option value='64421'>64421</option>
<option value='64425'>64425</option>
<option value='64430'>64430</option>
<option value='64447'>64447</option>
<option value='64450'>64450</option>
<option value='64483'>64483</option>
<option value='64484'>64484</option>
<option value='64490'>64490</option>
<option value='64491'>64491</option>
<option value='64492'>64492</option>
<option value='64493'>64493</option>
<option value='64494'>64494</option>
<option value='64495'>64495</option>
<option value='64505'>64505</option>
<option value='64510'>64510</option>
<option value='64520'>64520</option>
<option value='64530'>64530</option>
<option value='64633'>64633</option>
<option value='64634'>64634</option>
<option value='64635'>64635</option>
<option value='64636'>64636</option>
<option value='64640'>64640</option>
<option value='64680'>64680</option>
</select>
AnesthesiaCode:
<select id="anesSelect" onchange="anesChanged()" >
...
<option value='01610'>01610</option>
<option value='01730'>01730</option>
<option value='01810'>01810</option>
<option value='01935'>01935</option>
<option value='01936'>01936</option>
<option value='01991'>01991</option>
<option value='01992'>01992</option>
</select>
Base Units:
<input id="baseUnits" type="text" size="4" onchange="computeAnesFee()"></input>
Time (minutes):
<input id="timeUnits" type="text" size="4" onchange="computeAnesFee()"></input>
Total Units:
<input id="totalUnits" type="text" size="4"></input>
<br>
<script>

function myFunction() {

    var x = document.getElementById("cptSelect").value;
    var y = document.getElementById("anesSelect");
    var bu = document.getElementById("baseUnits");
...
function anesChanged() {

   var x = document.getElementById("baseUnits");
   var y = document.getElementById("anesSelect").value;
...
switch (y) {
    ...
    case '01250': x.value=4; break;

    case '01380': x.value=3; break;

    case '01462': x.value=3; break;

    case '01610': x.value=5; break;
    case '01730': x.value=3; break;

    case '01810': x.value=3; break;

    case '01935': x.value=5; break;

    case '01936': x.value=5; break;

    case '01991': x.value=3; break;

    case '01992': x.value=5; break;
...
function computeAnesFee() {

   var bu = document.getElementById("baseUnits").value;
   var tu = document.getElementById("timeUnits").value;
   var af = document.getElementById("totalUnits");

   af.value = Math.round(parseInt(bu)+parseInt(tu)/15);
}
