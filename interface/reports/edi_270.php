...
left join form_encounter as fe on (fe.date = (select date from form_encounter where pid = p.pid and date(date) < e.pc_eventDate order by date desc limit 1) and fe.pid=p.pid )
