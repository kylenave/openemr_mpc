...
$report_name = "New Denied Claims";
$report_file = "new_denied_claims";
...
<?php
  ...
  if ($_POST['form_refresh'] || $_POST['form_csvexport']) {
    $columns = array("Last Name"=>"lname", "First Name"=>"fname","Date of Service"=>"dos");
    $moneyFormat = array();
    ...
    $sqlBindArray = array();
    $query = "
select p.lname, p.fname, date(fe.date) as dos from form_encounter fe
