...
$report_name = "Note Summary";
$report_file = "note_summary";
...
<?php
  ...
  if ($_POST['form_refresh'] || $_POST['form_csvexport']) {
    $columns = array("Date"=>"date", "User"=>"user","Count"=>"count");
   ...
   array_push($sqlBindArray,"$from_date 00:00:00","$to_date 23:59:59");
    ...
    // If a provider was specified.
      ...
      $query .= " GROUP BY date(bn.date), u.fname ORDER BY date(bn.date), u.fname ";
